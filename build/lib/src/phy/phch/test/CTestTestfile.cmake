...
# Source directory: /home/FE/pilz/working/sidelink/lib/src/phy/phch/test
# Build directory: /home/FE/pilz/working/sidelink/build/lib/src/phy/phch/test
# 
# This file includes the relevant testing commands required for 
# testing this directory and lists subdirectories to be tested as well.
add_test(psbch_test_6 "psbch_test" "-p" "1" "-n" "6" "-c" "301")
add_test(psbch_test_15 "psbch_test" "-p" "1" "-n" "15" "-c" "302")
add_test(psbch_test_25 "psbch_test" "-p" "1" "-n" "25" "-c" "303")
add_test(psbch_test_50 "psbch_test" "-p" "1" "-n" "50" "-c" "304")
add_test(pscch_test_6 "pscch_test" "-p" "1" "-n" "6" "-c" "301")
add_test(pscch_test_15 "pscch_test" "-p" "1" "-n" "15" "-c" "302")
add_test(pscch_test_25 "pscch_test" "-p" "1" "-n" "25" "-c" "303")
add_test(pscch_test_50 "pscch_test" "-p" "1" "-n" "50" "-c" "304")
add_test(pssch_test_6 "pssch_test" "-p" "1" "-n" "6" "-c" "301")
add_test(pssch_test_15 "pssch_test" "-p" "1" "-n" "15" "-c" "302")
add_test(pssch_test_25 "pssch_test" "-p" "1" "-n" "25" "-c" "303")
add_test(pssch_test_50 "pssch_test" "-p" "1" "-n" "50" "-c" "304")
add_test(pssch_test_full_6 "pssch_test_full" "-p" "1" "-n" "6")
add_test(pssch_test_full_50 "pssch_test_full" "-p" "1" "-n" "50")
...
add_test(psbch_file_test_6 "psbch_file_test" "-p" "1" "-n" "6" "-c" "301" "-i" "/home/FE/pilz/working/sidelink/lib/src/phy/phch/test/6_tx_output.dat")
add_test(psbch_file_test_15 "psbch_file_test" "-p" "1" "-n" "15" "-c" "301" "-i" "/home/FE/pilz/working/sidelink/lib/src/phy/phch/test/15_tx_output.dat")
add_test(psbch_file_test_25 "psbch_file_test" "-p" "1" "-n" "25" "-c" "301" "-i" "/home/FE/pilz/working/sidelink/lib/src/phy/phch/test/25_tx_output.dat")
add_test(psbch_file_test_50 "psbch_file_test" "-p" "1" "-n" "50" "-c" "301" "-i" "/home/FE/pilz/working/sidelink/lib/src/phy/phch/test/50_tx_output.dat")
add_test(pbch_file_test "pbch_file_test" "-i" "/home/FE/pilz/working/sidelink/lib/src/phy/phch/test/signal.1.92M.dat")
add_test(pcfich_file_test "pcfich_file_test" "-c" "150" "-n" "50" "-p" "2" "-i" "/home/FE/pilz/working/sidelink/lib/src/phy/phch/test/signal.10M.dat")
add_test(phich_file_test "phich_file_test" "-c" "150" "-n" "50" "-p" "2" "-i" "/home/FE/pilz/working/sidelink/lib/src/phy/phch/test/signal.10M.dat")
add_test(pdcch_file_test "pdcch_file_test" "-c" "1" "-f" "3" "-n" "6" "-p" "1" "-i" "/home/FE/pilz/working/sidelink/lib/src/phy/phch/test/signal.1.92M.amar.dat")
add_test(pdsch_pdcch_file_test "pdsch_pdcch_file_test" "-c" "1" "-f" "3" "-n" "6" "-p" "1" "-i" "/home/FE/pilz/working/sidelink/lib/src/phy/phch/test/signal.1.92M.amar.dat")
add_test(pmch_file_test "pmch_file_test" "-i" "/home/FE/pilz/working/sidelink/lib/src/phy/phch/test/pmch_100prbs_MCS2_SR0.bin")
add_test(pscch_file_test "pscch_file_test" "-n" "25" "-m" "0" "-i" "/home/FE/pilz/working/sidelink/lib/src/phy/phch/test/v2x_pscch_25prb_301cid.bin")
