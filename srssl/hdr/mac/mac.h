...
public:
  ...
  // sidelink id to be inserted into SL_SCH MAC subheader
  int32_t sidelink_id;
...
private:  
  ...
  sl_harq_entity<MAC_NOF_HARQ_PROC, mac_grant_t, tb_action_dl_t, srslte_phy_grant_t> sl_harq;
  sl_harq_tx_entity<MAC_NOF_HARQ_PROC, mac_grant_t, tb_action_ul_t, srslte_phy_grant_t> sl_harq_tx;
