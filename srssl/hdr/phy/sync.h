...
#include "srssl/hdr/phy/scell/async_scell_recv.h"

#include <srssl/hdr/phy/scell/intra_measure.h>
...
public:
  ...
  bool    cell_create(phy_interface_rrc_lte::phy_cell_t *new_cell);
...
private:
  ...
  public:
    ...
    bool is_serving() { return cur_state == SERVING; }
