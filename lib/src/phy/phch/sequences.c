 ...
 * 36.211 v14.2 9.6.1
 */
int srslte_sequence_psbch(srslte_sequence_t *seq, uint32_t cell_id, uint32_t len) {
  return srslte_sequence_LTE_pr(seq, len, cell_id);
}

/**
 * 36.211 v14.2 9.3.1
 */
int srslte_sequence_pssch(srslte_sequence_t *seq, uint32_t len, uint32_t n_X_ID, uint32_t n_PSSCH_ssf) {
  return srslte_sequence_LTE_pr(seq, len, (n_X_ID<<14) + (n_PSSCH_ssf<<9) + 510);
}

/**
 * 36.211 v14.2 9.4.2
 */
int srslte_sequence_pscch(srslte_sequence_t *seq, uint32_t len) {
  return srslte_sequence_LTE_pr(seq, len, 510);
}
