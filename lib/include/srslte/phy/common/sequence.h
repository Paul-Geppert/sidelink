...
SRSLTE_API int srslte_sequence_psbch(srslte_sequence_t *seq,
                                      uint32_t cell_id,
                                      uint32_t len);

SRSLTE_API int srslte_sequence_pscch(srslte_sequence_t *seq,
                                      uint32_t len);

SRSLTE_API int srslte_sequence_pssch(srslte_sequence_t *seq,
                                      uint32_t len,
                                      uint32_t n_X_ID,
