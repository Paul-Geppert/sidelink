 ...
 *                procedure.
 *
 *                The main function is srslte_ue_sl_sync_get_buffer(), which returns
 ...
 *                init function srslte_ue_sl_sync_init_file(). The sampling frequency
...
#ifndef SRSLTE_UE_SL_SYNC_H
#define SRSLTE_UE_SL_SYNC_H
...
//typedef enum SRSLTE_API { SF_FIND, SF_TRACK} srslte_ue_sl_sync_state_t;
...
typedef struct SRSLTE_API {
  ...
  uint32_t frame_len; 
  uint32_t fft_size;
  uint32_t nof_recv_sf;  // Number of subframes received each call to srslte_ue_sl_sync_get_buffer
...
SRSLTE_API int srslte_ue_sl_sync_init(srslte_ue_sl_sync_t *q, 
                                   uint32_t max_prb,
                                   bool search_cell,
                                   int (recv_callback)(void*, void*, uint32_t, srslte_timestamp_t*), 
                                   void *stream_handler);

SRSLTE_API int srslte_ue_sl_sync_init_multi(srslte_ue_sl_sync_t *q,
                                         uint32_t max_prb,
                                         bool search_cell,
                                         int (recv_callback)(void*, cf_t*[SRSLTE_MAX_PORTS], uint32_t, srslte_timestamp_t*), 
                                         uint32_t nof_rx_antennas,
...
SRSLTE_API int srslte_ue_sl_sync_init_multi_decim(srslte_ue_sl_sync_t *q,
                                               uint32_t max_prb,
                                               bool search_cell,
                                               int (recv_callback)(void*, cf_t*[SRSLTE_MAX_PORTS], uint32_t, srslte_timestamp_t*),
                                               uint32_t nof_rx_antennas,
...
SRSLTE_API int srslte_ue_sl_sync_init_file_multi(srslte_ue_sl_sync_t *q,
                                              uint32_t nof_prb,
                                              char *file_name,
                                              int offset_time,
                                              float offset_freq,
...
SRSLTE_API void srslte_ue_sl_sync_free(srslte_ue_sl_sync_t *q);

SRSLTE_API void srslte_ue_sl_sync_file_wrap(srslte_ue_sl_sync_t *q,
                                         bool enable);

SRSLTE_API int srslte_ue_sl_sync_set_cell(srslte_ue_sl_sync_t *q,
                                       srslte_cell_t cell);

SRSLTE_API void srslte_ue_sl_sync_cfo_reset(srslte_ue_sl_sync_t *q);
...
SRSLTE_API void srslte_ue_sl_sync_set_agc_period(srslte_ue_sl_sync_t *q, 
                                              uint32_t period); 
...
SRSLTE_API void srslte_ue_sl_sync_copy_cfo(srslte_ue_sl_sync_t *q,
                                        srslte_ue_sl_sync_t *src_obj);

SRSLTE_API void srslte_ue_sl_sync_set_cfo_loop_bw(srslte_ue_sl_sync_t *q,
                                               float bw_pss,
                                               float bw_ref,
                                               float pss_tol,
                                               float ref_tol,
...
SRSLTE_API void srslte_ue_sl_sync_set_cfo_ema(srslte_ue_sl_sync_t *q,
                                           float ema);

SRSLTE_API void srslte_ue_sl_sync_set_cfo_ref(srslte_ue_sl_sync_t *q, float res_cfo);

SRSLTE_API void srslte_ue_sl_sync_set_cfo_i_enable(srslte_ue_sl_sync_t *q,
                                                bool enable);

SRSLTE_API void srslte_ue_sl_sync_set_N_id_2(srslte_ue_sl_sync_t *q,
                                          uint32_t N_id_2);

SRSLTE_API void srslte_ue_sl_sync_decode_ssss_on_track(srslte_ue_sl_sync_t *q, 
                                                        bool enabled);

SRSLTE_API uint32_t srslte_ue_sl_sync_get_sfidx(srslte_ue_sl_sync_t *q);
